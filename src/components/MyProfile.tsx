...
export function MyProfile({ onBack, user, onSignOut }: MyProfileProps) {
               ...
               <Card className="border-0 shadow-sm bg-white dark:bg-gray-800">
                 <CardHeader className="bg-gray-50 dark:bg-gray-700/50">
                   <div className="flex items-center justify-between">
                     ...
                     <Button size="sm" onClick={() => window.location.href = '/schedule'} className="bg-purple-500 hover:bg-purple-600 text-white">
                       <Plus className="w-4 h-4 mr-1" />
                       Create Session
                     </Button>
                   </div>
